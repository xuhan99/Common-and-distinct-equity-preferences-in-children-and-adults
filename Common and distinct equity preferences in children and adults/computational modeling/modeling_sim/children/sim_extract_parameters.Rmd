...
load('./stan_output/sim_fit_m4a_children.RData')

###########################################################################individual paramters#######################################################################
# Extract from the Stan fit object
parVals <- rstan::extract(fit_m4a_children, permuted = TRUE)
...
write.csv(allIndPars,file='sim_IndPars_fitm4a_children.csv',row.names = FALSE)
