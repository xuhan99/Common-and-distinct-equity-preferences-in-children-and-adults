...
1. load the csv data.
```{r}
raw_data                     <- fread(file='sim_data_children.csv') #load as data.table: https://digitaschools.com/read-csv-in-r-importing-data/
...
save(fit_m4a_children,file='./stan_output/sim_fit_m4a_children.RData')
