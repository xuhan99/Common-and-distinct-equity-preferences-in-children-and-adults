...
parameters {
  ...
  vector[5] mu_pr; //mean of the parameters, 4 advantageous inequality aversion and a inverse temperature.
...
model {
  ...
  for (i in 1:Ns) {
    ...
    util[cn] = Xself - alpha_temp*fmax(Xself-Xother,0); // utility of each possible choices
    }
