...
1. load the csv data.
```{r}
raw_data                     <- fread(file='data_children.csv') #load as data.table: https://digitaschools.com/read-csv-in-r-importing-data/
...
pars_m4a_children <- c('mu_alpha11','mu_alpha12','mu_alpha21','mu_alpha22','mu_beta11','mu_beta12','mu_beta21','mu_beta22','mu_tau','sigma','alpha11','alpha12','alpha21','alpha22','beta11','beta12','beta21','beta22','tau','log_lik')
fit_m4a_children <- stan(file=paste0(getwd(),'/stan_model/m4a_tradeoff.stan'), data=data_list,
                        pars    = pars_m4a_children,
                        chains  = 3,
                        iter    = 4000,
                        warmup  = 2000,
                        thin    = 1,
...
save(fit_m4a_children,file='./stan_output/fit_m4a_children.RData')
printFit(fit_m4a_children,ic='both')
...
pars_m1a_children <- c('mu_alpha11','mu_alpha12','mu_alpha21','mu_alpha22','mu_tau','sigma','alpha11','alpha12','alpha21','alpha22','tau','log_lik')
fit_m1a_children <- stan(file=paste0(getwd(),'/stan_model/m1a_tradeoff.stan'), data=data_list,
                         pars    = pars_m1a_children,
                         chains  = 3,
                         iter    = 4000,
                         warmup  = 2000,
                         thin    = 1,
...
#################################################################model fit & save model & plots#############################################################
save(fit_m1a_children,file='./stan_output/fit_m1a_children.RData')
printFit(fit_m1a_children,ic='both')
...
pars_m2a_children <- c('mu_beta11','mu_beta12','mu_beta21','mu_beta22','mu_tau','sigma','beta11','beta12','beta21','beta22','tau','log_lik')
fit_m2a_children <- stan(file=paste0(getwd(),'/stan_model/m2a_tradeoff.stan'), data=data_list,
                         pars    = pars_m2a_children,
                         chains  = 3,
                         iter    = 4000,
                         warmup  = 2000,
                         thin    = 1,
...
#################################################################model fit & save model & plots#############################################################
save(fit_m2a_children,file='./stan_output/fit_m2a_children.RData')
printFit(fit_m2a_children,ic='both')
...
pars_m3a_children <- c('mu_alpha11','mu_alpha12','mu_alpha21','mu_alpha22','mu_tau','sigma','alpha11','alpha12','alpha21','alpha22','tau','log_lik')
fit_m3a_children <- stan(file=paste0(getwd(),'/stan_model/m3a_tradeoff.stan'), data=data_list,
                         pars    = pars_m3a_children,
                         chains  = 3,
                         iter    = 4000,
                         warmup  = 2000,
                         thin    = 1,
...
#################################################################model fit & save model & plots#############################################################
save(fit_m3a_children,file='./stan_output/fit_m3a_children.RData')
printFit(fit_m3a_children,ic='both')
